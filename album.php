...
<body>
    ...
    <div class="container mt-4 mb-5">
        ...
        <form action="tambah_album.php" method="post" class="col-lg-5"><b>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="hapus_album.php?albumid=<?= $data['albumid'] ?>" class="btn btn-danger"><i class="bi bi-trash"></i><b> Hapus</b></a>
